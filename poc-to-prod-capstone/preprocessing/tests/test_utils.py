...
class TestBaseTextCategorizationDataset(unittest.TestCase):
    ...
    def test_get_index_to_label_map(self):
        base = utils.BaseTextCategorizationDataset(20, 0.8)
        base.get_index_to_label_map = MagicMock(return_value=100)
        self.assertEqual(base.get_index_to_label_map(), 100)

    def test_index_to_label_and_label_to_index_are_identity(self):
        base = utils.BaseTextCategorizationDataset(20, 0.8)
        base.get_label_to_index_map = MagicMock(return_value=100)
        self.assertEqual(base.get_label_to_index_map(), 100)

    def test_to_indexes(self):
        base = utils.BaseTextCategorizationDataset(20, 0.8)
        base.to_indexes = MagicMock(return_value=100)
        self.assertEqual(base.to_indexes(), 100)
